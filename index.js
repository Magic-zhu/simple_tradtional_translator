...
translator.prototype.init=function(dom,type){
 ...
 * @returns {String} - 转换结果
 */
translator.prototype.tranStr = function(str, toT) {
  var i;
  var letter;
  var code;
  var isChinese;
 ...
 * @param {Boolean} toT - 是否转换成繁体
 */
translator.prototype.tranAttr = function(element, attr, toT) {
  var i, attrValue;
 ...
 * @param {Boolean} toT - 是否转换成繁体
 */
translator.prototype.tranElement = function(element, toT) {
  var i;
  var childNodes;
  ...
  for (i = 0; i < childNodes.length; i++) {
    ...
    if (childNode.nodeType === 1) {
      // 对以下标签不做处理
      if (
        "|BR|HR|TEXTAREA|SCRIPT|OBJECT|EMBED|".indexOf(
          "|" + childNode.tagName + "|"
        ) !== -1
      ) {
        continue;
      ...
      this.tranAttr(
        childNode,
        ["title", "data-original-title", "alt", "placeholder"],
        toT
      );
      // input 标签
      // 对text类型的input输入框不做处理
      if (
        childNode.tagName === "INPUT" &&
        childNode.value !== "" &&
        childNode.type !== "text" &&
 ...
 * @returns {String} 转换结果
 */
translator.prototype.s2t = function(str) {
  return this.tranStr(str, true);
};
/**
 * 文本繁转简
 * @param {String} str - 待转换的文本
 * @returns {String} 转换结果
 */
translator.prototype.t2s = function(str) {
  return this.tranStr(str, false);
};
translator.prototype.S2T = function(dom) {
  return this.tranElement(dom, true);
};
translator.prototype.T2S = function(dom) {
  return this.tranElement(dom, false);
};